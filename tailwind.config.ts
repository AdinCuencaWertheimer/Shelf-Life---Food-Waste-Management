  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        fridge: {
          DEFAULT: "hsl(var(--fridge))",
          foreground: "hsl(var(--fridge-foreground))",
        },
        pantry: {
          DEFAULT: "hsl(var(--pantry))",
          foreground: "hsl(var(--pantry-foreground))",
        },
        freezer: {
          DEFAULT: "hsl(var(--freezer))",
          foreground: "hsl(var(--freezer-foreground))",
        },
        sidebar: {
